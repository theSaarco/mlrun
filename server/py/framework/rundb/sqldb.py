...
class SQLRunDB(RunDBInterface):
    ...
    def get_project(
        self, name: str | None = None, project_id: int | None = None
    ) -> mlrun.common.schemas.Project:
        return self._transform_db_error(
    ...
    def list_projects(
        ...
        return self._transform_db_error(
            services.api.crud.Projects().list_projects,
            self.session,
            owner=owner,
            format_=format_,
            labels=labels,
    ...
    def create_feature_set(self, feature_set, project="", versioned=True):
        return self._transform_db_error(
            services.api.crud.FeatureStore().create_feature_set,
            self.session,
            project,
            feature_set,
            versioned,
    ...
    def store_feature_set(
        ...
        return self._transform_db_error(
            services.api.crud.FeatureStore().store_feature_set,
            self.session,
            project,
            name,
            feature_set,
    ...
    def delete_feature_set(self, name, project="", tag=None, uid=None):
        return self._transform_db_error(
            services.api.crud.FeatureStore().delete_feature_set,
            self.session,
            project,
            name,
            tag,
    ...
    def list_feature_vectors(
        ...
        return self._transform_db_error(
            services.api.crud.FeatureStore().list_feature_vectors,
            self.session,
            project,
            name,
            tag,
    ...
    def delete_feature_vector(self, name, project="", tag=None, uid=None):
        return self._transform_db_error(
            services.api.crud.FeatureStore().delete_feature_vector,
            self.session,
            project,
            name,
            tag,
    ...
    def store_alert_notifications(
        ...
        return self._transform_db_error(
            framework.db.session.run_function_with_new_db_session,
            services.api.crud.Notifications().store_alerts_notifications,
            notification_objects,
            alert_id,
            project,
            mask_params,
    ...
    def function_status(self, project, name, kind, selector):
        ...
        """
        return self._transform_db_error(
            services.api.crud.Functions().get_function_status,
            kind,
            selector,
        )
